...
export const servicePages: ServicePage[] = [
  ...
  { slug: "corporate-legal-advisory", title: "Corporate Legal Advisory", keyword: "China Corporate Legal Advisory", summary: "Practical corporate legal consulting for foreign-invested companies, covering governance, contracts, employment compliance, shareholder changes, IP coordination, dispute prevention, and external counsel collaboration.", audience: "foreign-invested companies needing legal and compliance coordination in China" },
