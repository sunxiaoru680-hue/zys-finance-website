      ...
      <div className="container-shell flex min-h-20 items-center justify-between gap-4">
        <Link href="/" className="focus-ring flex items-center gap-3 rounded-md">
          ...
          <span className="leading-tight">
            <span className="block text-sm font-bold tracking-normal text-ink md:text-base">
              {companyName}
            </span>
            <span className="block text-xs font-semibold uppercase text-graphite">
              ZYS International Business Advisory
            </span>
          </span>
        </Link>
