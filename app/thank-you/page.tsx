  ...
  return (
    <>
      <PageHero
        ...
        description="Your inquiry has been received. Our team will review your company registration, legal advisory, tax, accounting, visa, licensing, audit or overseas setup request and respond through your preferred contact channel."
      ...
      <section className="py-16 md:py-20">
        <div className="container-shell max-w-3xl rounded-md border border-line bg-white p-7 shadow-sm md:p-9">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <WhatsAppButton source="thank_you" className="focus-ring inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-evergreen px-5 py-3 text-sm font-semibold text-white transition hover:bg-ink">
