    ...
    <>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container-shell max-w-4xl">
          <p className="text-sm font-bold uppercase text-evergreen">Process Timeline</p>
      ...
      <section className="py-16 md:py-24">
        <div className="container-shell grid gap-8 lg:grid-cols-[0.7fr_0.3fr]">
          <article className="rounded-md border border-line bg-white p-8 shadow-sm">
            ...
            <p className="mt-5 text-base leading-8 text-graphite">The exact timeline for any project depends on the service scope, city or jurisdiction, document readiness, authority review, and third-party provider response times.</p>
          </article>
