...
export const metadata: Metadata = createPageMetadata({
  title: "Terms",
  description: "Website terms for using ZYS consulting information and requesting advisory services.",
    ...
    <>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container-shell max-w-4xl">
          ...
          <h1 className="mt-4 text-4xl font-bold leading-tight md:text-6xl">Terms</h1>
          <p className="mt-6 text-lg leading-8 text-graphite">Website terms for using ZYS consulting information and requesting advisory services.</p>
        </div>
      </section>
      <section className="py-16 md:py-24">
        <div className="container-shell grid gap-8 lg:grid-cols-[0.7fr_0.3fr]">
          <article className="rounded-md border border-line bg-white p-8 shadow-sm">
            <p className="text-base leading-8 text-graphite">The information on this website is for general business education and does not replace formal legal, tax, accounting, immigration, or investment advice. Service scope, pricing, timelines, and deliverables depend on the client situation and must be confirmed in writing. Using this website or submitting an inquiry does not create an engagement until ZYS accepts the project scope.</p>
