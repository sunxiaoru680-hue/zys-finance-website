...
export default function BlogPage() {
  return (
    <>
      <StructuredData data={breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Insights", path: "/blog" }])} />
      <Breadcrumbs items={[{ name: "Home", href: "/" }, { name: "Insights", href: "/blog" }]} />
      <section className="bg-white py-16 md:py-24">
        <div className="container-shell">
          <p className="text-sm font-bold uppercase text-evergreen">Insights</p>
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-graphite">Practical articles on China market entry, company setup, business licenses, accounting records, tax filing, payroll, work permits, audit preparation, and cross-border company planning.</p>
        </div>
      </section>
