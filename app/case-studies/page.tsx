...
export const metadata: Metadata = createPageMetadata({
  title: "Case Studies",
  description: "Representative China registration, accounting, tax, visa, license, and compliance scenarios.",
    ...
    <>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container-shell max-w-4xl">
          ...
          <h1 className="mt-4 text-4xl font-bold leading-tight md:text-6xl">Case Studies</h1>
          <p className="mt-6 text-lg leading-8 text-graphite">Representative China registration, accounting, tax, visa, license, and compliance scenarios.</p>
        </div>
      </section>
